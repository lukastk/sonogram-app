...
# Ein Schnitt durch diesen Datensatz entspr   icht jetzt dem Bild eines Sono-Echos. Der einfachste Schnitt ist entlang einer Dimension, hier `z = 300`. Der Doppelpunkt bedeutet (ähnlich wie bei Fortran), dass alle Werte entlang dieser Dimension betrachtet werden.
...
image = VOLUME[:,150,:] # Querschnitt durch die z-Achse bei z = 300
